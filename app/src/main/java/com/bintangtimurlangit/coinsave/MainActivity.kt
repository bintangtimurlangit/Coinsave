...
import com.bintangtimurlangit.coinsave.pages.*
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // adjust the window's soft input mode to resize the content when the keyboard is shown
        ...
        setContent {
            CoinsaveTheme {
                ...
                // Navigation controller to manage navigation within the app
                val navController = rememberNavController()
                val backStackEntry by navController.currentBackStackEntryAsState()

                // Determine when to show or hide the bottom bar based on the current route
                ...
                Scaffold(
                    ...
                    content = { innerPadding ->
                        NavHost(
                            ...
                            // Composable for Categories page under Settings
